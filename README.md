...
Woho Studios ("we," "our," or "us") has developed the mobile application/game **Collect Chocolates** as a free/commercial product. This Privacy Policy is designed to inform users ("you") about our practices regarding the collection, use, and protection of information.  

## 1. Data Collection  
The **Collect Chocolates** application does not directly collect personal data. However, it interacts with external services, such as Google Play Games and Google AdMob, to enable certain features like cloud saving, achievements, and ad distribution.  
...
## 3. App Permissions  
The **Collect Chocolates** application may request permissions to access system functionality required to ensure proper operation of Google Play Games and Google AdMob features.  

---

## 4. Third-Party Services  
The **Collect Chocolates** application uses the following third-party services:  
